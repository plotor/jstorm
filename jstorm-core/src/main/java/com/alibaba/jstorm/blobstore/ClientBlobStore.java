...
public abstract class ClientBlobStore implements Shutdownable {
     ...
     */
    protected abstract AtomicOutputStream createBlobToExtend(String key, SettableBlobMeta meta) throws KeyAlreadyExistsException;
     ...
     * @throws KeyNotFoundException
     */
    protected abstract void setBlobMetaToExtend(String key, SettableBlobMeta meta) throws KeyNotFoundException;
     ...
     * @throws KeyNotFoundException
     */
    public abstract int getBlobReplication(String key) throws KeyNotFoundException;
     ...
     * @throws KeyNotFoundException
     */
    public abstract int updateBlobReplication(String key, int replication) throws KeyNotFoundException;
     ...
     * @throws KeyAlreadyExistsException
     */
    public final AtomicOutputStream createBlob(String key, SettableBlobMeta meta) throws KeyAlreadyExistsException {
