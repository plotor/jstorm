...
public interface ISupervisor {
     ...
     * The combination of this and getSupervisorId allows Nimbus to assign to a single machine and have multiple
     * supervisors on that machine execute the assignment. This is important for achieving resource isolation.
     */
